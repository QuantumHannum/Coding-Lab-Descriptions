...
3. Your scatter plot time_plot.png is a window into the computational 'difficulty' in searching for a solution.  Looking at your scatter plot, what conclusions can you draw?  This paper https://arxiv.org/pdf/cs/0005024 provides further detail on both the phase transition and computational 'difficulty' of a classical algorithm.  Does your data suggest a difference in the computational difficulty of the classical approach from the quantum approach?  Provide some substantive comments on the difference between classical SAT solvers and your implementation of Grover's Algorithm.  Use your plot depth_plot.png for some evidence.
4. This random 3-SAT problem on the surface seems disconnected from physics, but it has broad applications to thermodynamic problems.  Specifically, anything that can be modeled with an Ising Model https://en.wikipedia.org/wiki/Ising_model.  It even turns out that D-Wave (a quantum computing company) is making money by solving Ising-type problems.  Read this paper https://www.dwavesys.com/media/vbklsvbh/weightedmaxsat_v2.pdf to find out more about how 3-SAT problems are Ising Model problems.  See if you can find other examples online of interesting problems that can be solved with the Ising model.  Give a short description of why your chosen Ising-like problem is interesting to you. 
